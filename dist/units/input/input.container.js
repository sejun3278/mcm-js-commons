...
function _Input(props) {
    var _a = props, defaultValue = _a.defaultValue, onChangeEvent = _a.onChangeEvent, delay = _a.delay, onResetConfirm = _a.onResetConfirm, value = _a.value, inputRef = _a.inputRef, name = _a.name;
