...
function _Anchor(props) {
    ...
    return (<error_1.default propsList={__assign({}, props)} requiredList={["href"]} mouduleName="_Anchor">
      <Anchor style={styles} href={href} target={notTarget ? "_self" : "_blank"} rel="noreferrer" className={(0, hooks_1.getAllComponentsClassName)("mcm-anchor-unit", className)}>
        {children}
      </Anchor>
    </error_1.default>);
}
