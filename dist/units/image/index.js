...
function _Image(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(error_1.default, __assign({ propsList: __assign({}, props), requiredList: ["src"], mouduleName: "_Image" }, { children: (0, jsx_runtime_1.jsx)(Img, { className: (0, hooks_1.getAllComponentsClassName)("mcm-image-unit", className), src: src, style: styles }) })));
}
