...
function _Button(_a) {
    ...
    return (<exports.Button className={getAllComponentsClassName("cmm-button-unit", className)} onClick={(!isDisable && onClickEvent) || undefined} role="button_click_event" style={styles} isDisable={isDisable}>
      {children}
    </exports.Button>);
}
