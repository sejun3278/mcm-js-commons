...
function _Button(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("button", __assign({ className: getAllComponentsClassName("cmm-button-unit", className), onClick: onClickEvent, role: "button_click_event" }, { children: children })));
}
