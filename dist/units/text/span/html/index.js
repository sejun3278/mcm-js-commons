...
function _SpanTextWithHtml(props) {
    ...
    var getRender = function () {
        return !dangerouslySetInnerHTML ? ((0, jsx_runtime_1.jsx)(__1.SpanText, __assign({ isError: true }, { children: "<_SpanTextWithHtml /> : * dangerouslySetInnerHTML props\uAC00 \uD544\uC694\uD569\uB2C8\uB2E4." }))) : ((0, jsx_runtime_1.jsx)(__1.SpanText, { style: styles, className: (0, hooks_1.getAllComponentsClassName)("mcm-span-unit", className), isError: isError, dangerouslySetInnerHTML: {
