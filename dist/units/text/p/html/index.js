...
function _PTextWithHtml(props) {
    ...
    var getRender = function () {
        return !dangerouslySetInnerHTML ? ((0, jsx_runtime_1.jsx)(__1.PText, __assign({ isError: true }, { children: "<_PTextWithHtml /> : * dangerouslySetInnerHTML props\uAC00 \uD544\uC694\uD569\uB2C8\uB2E4." }))) : ((0, jsx_runtime_1.jsx)(__1.PText, { style: styles, className: getAllComponentsClassName("mcm-p-unit", className), isError: isError, dangerouslySetInnerHTML: {
