...
function _CloseButton(_a) {
    ...
    buttonColor = _a.buttonColor, disable = _a.disable, // 닫기 비활성화
    ...
    return ((0, jsx_runtime_1.jsx)(exports.ButtonWrapper, { className: getAllComponentsClassName("mcm-close-button-unit", className), buttonSize: getPXForm(buttonSize || "15px", "15px"), buttonWeight: getPXForm(buttonWeight || "1px", "1px"), buttonColor: buttonColor || "black", onClick: (!disable && onClickEvent) || undefined, disable: disable }));
}
