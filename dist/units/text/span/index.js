...
function _SpanText(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(__1.SpanText, __assign({ style: styles, className: getAllComponentsClassName("mcm-span-unit", className), isError: isError }, { children: children })));
}
