...
function _Anchor(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Anchor, __assign({ style: styles, href: href, target: notTarget ? "_self" : "_blank", rel: "noreferrer", className: getAllComponentsClassName("mcm-anchor-unit", className) }, { children: children })));
}
