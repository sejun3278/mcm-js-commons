...
function _Title(_a) {
    var children = _a.children, styles = _a.styles, className = _a.className, id = _a.id, titleLevel = _a.titleLevel;
    // 렌더할 태그명
    ...
    return ((0, jsx_runtime_1.jsx)(TitleTag, __assign({ className: _className, style: _styles, id: id }, { children: children })));
}
